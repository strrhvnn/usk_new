        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @if (Auth::user()->role == 'admin')
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link :href="route('Admin.list_airline')" :active="request()->routeIs('Admin.list_airline')">
                            {{ __('Airline') }}
                        </x-nav-link>
                    </div>
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                ...
                @elseif (Auth::user()->role == 'user')
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link :href="route('User.List.Tiket')" :active="request()->routeIs('User.List.Tiket')">
                            {{ __('My Ticket') }}
                        </x-nav-link>
                    </div>
                @endif
